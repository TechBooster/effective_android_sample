...
public class MainActivity extends FragmentActivity {
	...
	private void drawFields() {
		...
		{
			Field field = new Field("東１(戦場)", new LatLng[]{
					new LatLng(35.630124,139.796915),
					new LatLng(35.630778,139.796384),
					new LatLng(35.631218,139.7972),
					new LatLng(35.630556,139.797725),
			});
		...
		{
			Field field = new Field("東２(戦場)", new LatLng[]{
					new LatLng(35.630556,139.797725),
					new LatLng(35.631218,139.79721),
					new LatLng(35.63168,139.798037),
					new LatLng(35.631018,139.798578),
			});
			field.setMemo("東方Project, ゲーム(電源不要), オンラインゲーム, ゲーム(その他)");
		...
		{
			Field field = new Field("東３(戦場)", new LatLng[]{
					new LatLng(35.631018,139.798578),
					new LatLng(35.631676,139.798047),
					new LatLng(35.632121,139.798873),
					new LatLng(35.631462,139.799404),
			});
			field.setMemo("東方Project, ゲーム(電源不要), オンラインゲーム, ゲーム(その他)");
		...
		{
			Field field = new Field("東４(戦場)", new LatLng[]{
					new LatLng(35.631384,139.796497),
					new LatLng(35.632038,139.795971),
					new LatLng(35.632478,139.796771),
					new LatLng(35.631816,139.797307),
			});
		...
		{
			Field field = new Field("東５(戦場)", new LatLng[]{
					new LatLng(35.631816,139.797307),
					new LatLng(35.632483,139.796808),
					new LatLng(35.632884,139.797602),
					new LatLng(35.632226,139.798133),
			});
			field.setMemo("ギャルゲー, Leaf & Key, TYPE-MOON, 同人ソフト, スクウェア・エニックス(RPG), ゲーム(RPG)");
		...
		{
			Field field = new Field("東６(戦場)", new LatLng[]{
					new LatLng(35.632226,139.798133),
					new LatLng(35.632901,139.797624),
					new LatLng(35.633346,139.798444),
					new LatLng(35.632683,139.798981),
			});
			field.setMemo("ギャルゲー, Leaf & Key, TYPE-MOON, 同人ソフト, スクウェア・エニックス(RPG), ゲーム(RPG)");
		...
		{
			Field field = new Field("西棟(戦場)", new LatLng[]{
					new LatLng(35.628044,139.794882),
					new LatLng(35.628419,139.794625),
					new LatLng(35.628655,139.794689),
					new LatLng(35.628995,139.794399),
					new LatLng(35.629282,139.794823),
					new LatLng(35.629509,139.794882),
					new LatLng(35.62974,139.795295),
					new LatLng(35.628737,139.796121),
			});
